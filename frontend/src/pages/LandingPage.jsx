    ...
    <div className="lp">
      ...
      <div className="lp-sw" id="pricing">
        ...
        <div className="lp-pg">
          ...
          <div className="lp-prc"><div className="lp-popb" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:5,background:"#8b5cf6"}}><Target size={13} strokeWidth={2}/> Grade 11–12 · New</div><div className="lp-prname">Exam Prep Center</div><div className="lp-pramount">&#8377;1,999<span>/year</span></div><div className="lp-prdesc">JEE Main, NEET UG, CUET UG, SAT, IELTS & TOEFL iBT — all six exams in one annual plan for Grade 11 & 12 students.</div><div className="lp-prf">JEE Main — Study Plan + Test Simulation</div><div className="lp-prf">NEET UG — Study Plan + Test Simulation</div><div className="lp-prf">CUET UG — Study Plan + Test Simulation</div><div className="lp-prf">SAT — Study Plan + Test Simulation</div><div className="lp-prf">IELTS — Study Plan + Test Simulation</div><div className="lp-prf">TOEFL iBT — Study Plan + Test Simulation</div><div className="lp-prf">AI step-by-step explanations</div><div className="lp-prf">Weak topic tracker</div><button className="lp-bpro lp-bpout" onClick={() => handleCta("exam_prep_center")}>Get Exam Prep Center</button></div>
        </div>
