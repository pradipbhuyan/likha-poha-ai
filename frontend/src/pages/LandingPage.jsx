    ...
    <div className="lp">
      ...
      <div className="lp-sw" id="pricing">
        ...
        <div className="lp-pg">
          ...
          <div className="lp-prc" style={{borderColor:"#f59e0b"}}><div className="lp-popb" style={{background:"#f59e0b"}}>🎁 1 Month Free</div><div className="lp-prname">Standard — 6 Months</div><div className="lp-pramount">&#8377;1,495<span>/6 months</span></div><div className="lp-prdesc" style={{color:"#f59e0b",fontWeight:700}}>₹249/month · Save ₹299</div><div className="lp-prf">Pay for 5, get 6 months free</div><div className="lp-prf">All CBSE subjects · All grades</div><div className="lp-prf">Unlimited doubt solving</div><div className="lp-prf">Full question bank access</div><div className="lp-prf">Parent dashboard + alerts</div><button className="lp-bpro lp-bpout" style={{borderColor:"#f59e0b",color:"#f59e0b"}} onClick={() => handleCta("standard_6month")}>Choose 6-Month</button></div>
          <div className="lp-prc" style={{borderColor:"#10b981"}}><div className="lp-popb" style={{background:"#10b981"}}>🏆 2 Months Free</div><div className="lp-prname">Standard — Annual</div><div className="lp-pramount">&#8377;2,999<span>/year</span></div><div className="lp-prdesc" style={{color:"#10b981",fontWeight:700}}>₹250/month · Save ₹589</div><div className="lp-prf">2 months free vs monthly</div><div className="lp-prf">All CBSE subjects · All grades</div><div className="lp-prf">Unlimited doubt solving</div><div className="lp-prf">Full question bank access</div><div className="lp-prf">Priority support</div><button className="lp-bpro lp-bpfill" style={{background:"#10b981"}} onClick={() => handleCta("standard_annual")}>Choose Annual</button></div>
          ...
          <div className="lp-prc" style={{borderColor:"#10b981"}}><div className="lp-popb" style={{background:"#10b981"}}>🏆 2 Months Free</div><div className="lp-prname">Family — Annual</div><div className="lp-pramount">&#8377;4,999<span>/year</span></div><div className="lp-prdesc" style={{color:"#10b981",fontWeight:700}}>₹417/month · Save ₹989</div><div className="lp-prf">2 months free vs monthly</div><div className="lp-prf">Up to 2 children</div><div className="lp-prf">All CBSE subjects · All grades</div><div className="lp-prf">Unlimited doubts for all</div><div className="lp-prf">Full parent dashboard</div><button className="lp-bpro lp-bpout" style={{borderColor:"#10b981",color:"#10b981"}} onClick={() => handleCta("family_annual")}>Choose Family Annual</button></div>
        </div>
        <p className="lp-prnote">Annual plans include 2 months free &middot; 6-month plan includes 1 month free &middot; No hidden charges</p>
      </div>
