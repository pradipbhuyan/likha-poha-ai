  ...
  return (
    <div className="lp">
      ...
      <div className="lp-sf" id="features"><div className="lp-si">
        ...
        <div className="lp-fg">
          ...
          <div style={{display:"flex",flexDirection:"column",gap:"16px"}}>
            <div className="lp-dc"><div className="lp-dh"><div className="lp-di" style={{background:"rgba(16,185,129,.2)"}}><HelpCircle size={16} strokeWidth={2}/></div>INSTANT DOUBT SOLVING</div><img src="/screenshots/S06-ask-doubt-answer.png" alt="Doubt Solving" style={{width:"100%",display:"block"}} loading="lazy" /></div>
            <div className="lp-dc"><div className="lp-dh"><div className="lp-di" style={{background:"rgba(99,102,241,.2)"}}><BarChart2 size={16} strokeWidth={2}/></div>STUDENT ANALYTICS</div><img src="/screenshots/S11-analytics-top.png" alt="Student Analytics" style={{width:"100%",display:"block"}} loading="lazy" /></div>
          </div>
        </div>
      </div></div>
      <div className="lp-sf"><div className="lp-si">
        ...
        <div className="lp-2col">
          <div className="lp-dc"><div className="lp-dh"><div className="lp-di" style={{background:"rgba(245,158,11,.2)"}}><Trophy size={16} strokeWidth={2}/></div>ACHIEVEMENTS AND BADGES</div><img src="/screenshots/S04-dash-xp-streak.png" alt="Gamified Dashboard" style={{width:"100%",display:"block"}} loading="lazy" /></div>
          <div className="lp-dc"><div className="lp-dh"><div className="lp-di" style={{background:"rgba(99,102,241,.2)"}}><Award size={16} strokeWidth={2}/></div>CLASS LEADERBOARD</div><img src="/screenshots/S12-leaderboard.png" alt="Leaderboard" style={{width:"100%",display:"block"}} loading="lazy" /></div>
        </div>
      </div></div>
      ...
      <div className="lp-sw" id="pricing">
        ...
        <div className="lp-pg">
          <div className="lp-prc pop"><div className="lp-popb" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:5}}><Star size={13} strokeWidth={2} fill="currentColor"/> Most Popular</div><div className="lp-prname">Premium</div><div className="lp-pramount">&#8377;299<span>/month</span></div><div className="lp-prdesc">Everything you need for serious CBSE exam prep — unlimited AI access every month.</div><div className="lp-prf">All CBSE subjects &middot; All grades</div><div className="lp-prf">Unlimited AI lessons, doubts & mock tests</div><div className="lp-prf">Exemplar Research & Lessons</div><div className="lp-prf">Formula & Concepts library</div><div className="lp-prf">Exam Prep Center (JEE, NEET, CUET, SAT, IELTS, TOEFL)</div><div className="lp-prf">10 Years of Board Papers with answers</div><div className="lp-prf">Learn More curated video library</div><div className="lp-prf">Parent dashboard + alerts</div><div className="lp-prf">Priority support</div><button className="lp-bpro lp-bpfill" onClick={() => handleCta("starter")}>Choose Premium</button></div>
          <div className="lp-prc"><div className="lp-prname">Family Premium</div><div className="lp-pramount">&#8377;499<span>/month</span></div><div className="lp-prdesc">Everything in Premium for up to 2 children — one shared family plan.</div><div className="lp-prf">Everything in Premium</div><div className="lp-prf">Up to 2 children with separate progress</div><div className="lp-prf">Exemplar Research & Lessons</div><div className="lp-prf">Formula & Concepts library</div><div className="lp-prf">Exam Prep Center (JEE, NEET, CUET, SAT, IELTS, TOEFL)</div><div className="lp-prf">10 Years of Board Papers with answers</div><div className="lp-prf">Learn More curated video library</div><div className="lp-prf">Parent dashboard + analytics</div><div className="lp-prf">Family learning management</div><button className="lp-bpro lp-bpout" onClick={() => handleCta("family_premium")}>Get Family Premium</button></div>
        </div>
