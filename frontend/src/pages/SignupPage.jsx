        ...
        <div className="ait-login-right signup-right-panel">
          <div className="ait-form-card" data-testid="signup-form-card">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              {/* Google Sign-In & Data Usage disclosure — required by Google OAuth policy */}
              <div style={{
                marginTop: 20,
                padding: "14px 16px",
                ...
                <strong style={{ display: "block", marginBottom: 6, fontSize: "0.78rem", color: "var(--text,#1e293b)" }}>
                  Google Sign-In & Data Usage
                </strong>
                <p style={{ margin: "0 0 6px" }}>
                  Likha Poha AI uses Google Sign-In only to securely authenticate users. We collect only your name, email address, and profile picture.
                </p>
                <p style={{ margin: 0 }}>
