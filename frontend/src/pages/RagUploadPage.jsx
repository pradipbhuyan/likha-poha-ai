...
const SCHOOL_BOARD_OPTIONS = ["CBSE", "State Board"];
...
function isAutoGeneratedBookTitle(value) {
  ...
  return /^Grade\s+\d+\s+(CBSE|State Board)\s+.+\s+(Text Book|Full Book|Book Set)$/i.test(
    String(value || "").trim()
  );
}
    ...
    <div className="rag-upload-page premium-page premium-rag-page">
      ...
      <section className="premium-section premium-rag-upload-panel">
        <div className="premium-header">
          ...
          <p>
            Upload full subject books for CBSE or State Board classes 1
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
          ...
          <label className="full-width-label">
            ...
            <select value={pasteBoardVal} onChange={e => setPasteBoardVal(e.target.value)} style={{ width: "100%", marginTop: 4 }}>
              <option>CBSE</option><option>State Board</option>
            </select>
          </label>
          <label className="full-width-label">
            Subject
