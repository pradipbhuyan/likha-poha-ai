...
const iS = {
  width:"100%",background:"#111827",border:"2px solid #1e293b",
  borderRadius:10,padding:"11px 14px",color:"#f8fafc",
...
export default function SalesLeadForm({ onSuccess }) {
  ...
  return (
    <div style={{background:"#0f172a",border:"1px solid #1e293b",borderRadius:14,padding:"20px 18px",position:"sticky",top:20}}>
      <h3 style={{fontSize:"1.05rem",fontWeight:800,marginBottom:16,color:"#f1f5f9"}}>➕ Submit New Lead</h3>
      <p style={{fontSize:".8rem",color:"#475569",marginBottom:16}}>
        Enter the student's details. When they sign up and pay, your commission is auto-confirmed.
      </p>
      <form onSubmit={onSubmit} style={{display:"flex",flexDirection:"column",gap:12}}>
        <label style={{display:"flex",flexDirection:"column",gap:5,fontSize:".87rem",color:"#cbd5e1"}}>
          Student Name *
        ...
        {err && <div style={{background:"rgba(239,68,68,.1)",border:"1px solid rgba(239,68,68,.3)",borderRadius:8,padding:"9px 12px",fontSize:".82rem",color:"#fca5a5"}}>{err}</div>}
        {ok  && <div style={{background:"rgba(34,197,94,.1)", border:"1px solid rgba(34,197,94,.3)", borderRadius:8,padding:"9px 12px",fontSize:".82rem",color:"#86efac"}}>{ok}</div>}
        ...
        <p style={{fontSize:".72rem",color:"#475569",textAlign:"center",margin:0}}>
