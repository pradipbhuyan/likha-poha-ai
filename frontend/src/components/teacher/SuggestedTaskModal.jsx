    ...
    <div
      ...
      <div style={{ background: "var(--panel,#fff)", borderRadius: 12, padding: 20, width: "100%", maxWidth: 480, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 8px 32px rgba(0,0,0,.2)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12 }}>
          <h4 style={{ margin: 0, display: "flex", alignItems: "center", gap: 6 }}><CheckCircle2 size={16}/>Create Task</h4>
          <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center" }}><X size={18}/></button>
        </div>
        ...
        <form onSubmit={doSave} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          {error && <div style={{ fontSize: ".82rem", color: "#dc2626", display: "flex", alignItems: "center", gap: 5 }}><AlertTriangle size={14}/>{error}</div>}
