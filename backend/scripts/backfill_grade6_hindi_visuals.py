...
CHAPTER_PDFS = [
    ...
    (546, "fhml106.pdf"),  # 6. मेरी माँ
    (547, "fhml107.pdf"),  # 7. जलाते चलो
    (548, "fhml108.pdf"),  # 8. सत्रिया और बिहू नृत्य
    (549, "fhml109.pdf"),  # 9. मैया मैं नहिं माखन खायो
    (550, "fhml110.pdf"),  # 10. परीक्षा
    (551, "fhml111.pdf"),  # 11. चेतक की वीरता
    (552, "fhml112.pdf"),  # 12. हिंद महासागर में छोटा-सा हिंदुस्ान
    (553, "fhml113.pdf"),  # 13. पेड़ की बात
]
