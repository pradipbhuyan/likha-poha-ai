#!/usr/bin/env python3
"""
Backfill + curate textbook images for Grade 10 Social Science (Political
Science, "Democratic Politics II") chapters.
...
grade_10_political_science/*_source.pdf) and curates them with
curate_prose_textbook_visuals.py's deterministic size+uniqueness signal.

Usage:
    cd backend
    python3 scripts/backfill_grade10_social_science_political_science_visuals.py --dry-run
    python3 scripts/backfill_grade10_social_science_political_science_visuals.py
"""
...
SOURCE_DIR = Path("/Users/a0247716/Downloads/GPT55_Prompts_grade_10_political_science")

# (rag_documents.id, source pdf filename)
CHAPTER_PDFS = [
    (340, "01_chapter_1_power_sharing_source.pdf"),
    (341, "02_chapter_2_federalism_source.pdf"),
    (342, "03_chapter_3_gender_religion_and_caste_source.pdf"),
    (343, "04_chapter_4_political_parties_source.pdf"),
    (344, "05_chapter_5_outcomes_of_democracy_source.pdf"),
]


def run(dry_run: bool, force: bool) -> None:
    print(f"\n  Backfill + curate Grade 10 Social Science (Political Science) visuals")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backfill + curate Grade 10 Social Science (Political Science) visuals")
